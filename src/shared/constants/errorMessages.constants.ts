export const ErrorMessages = {
  ...
  PLAYER_ALREADY_IN_BATTLE: (nickname: string) =>
    `Player with nickname '${nickname}' is already in the battle.`,
  PLAYER_NOT_FOUND: (nickname: string) =>
  ...
  BATTLE_FINISHED: "Battle is finished.",
